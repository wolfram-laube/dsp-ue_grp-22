...
For that, you need to carry out the full \emph{'Signal Processing Onramp course'} [1].
...
\begin{itemize}
    \item[[1]] \url{https://matlabacademy.mathworks.com/details/signal-processing-onramp/signalprocessing}
\end{itemize}
